...
def train_cgan(training_config):
    ...
    data = MyDataset(r'C:/Users/GuoylyL/Desktop/class.txt')
    # # # 将数据集导入DataLoader，进行shuffle以及选取batch_size
    mnist_data_loader = DataLoader(data, batch_size=training_config['batch_size'], shuffle=True, num_workers=0)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--batch_size", type=int, help="height of content and style images", default=2)
    ...
    parser.add_argument("--checkpoint_freq", type=int, help="checkpoint model saving (epoch) freq", default=10)
